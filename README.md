This repository is cloned from the official anonymous repository of the [paper](https://arxiv.org/abs/2102.12962).


# Bias Reduction in Multi-Step Goal-Conditioned Reinforcement Learning
The codebase supports MHER, MHER($\lambda$), MMHER, TMHER, BR-MHER, BR-MHER($\lambda$) and BR-MMHER.
